...
| WL-D007-07 | blocked | chummer-media-factory | `products/chummer/review/media-factory.AGENTS.template.md` | `.codex-design/review/REVIEW_CONTEXT.md` | blocked: destination repo path `/docker/chummercomplete/chummer-media-factory` not present as of `2026-03-11T18:28:47Z`; owner: fleet/repo-provisioning |
