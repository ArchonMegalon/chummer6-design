...
4. Delivery and release control:
   ...
   For Android delivery, read `ANDROID_APP_PRODUCT_SPEC.md` -> `ANDROID_PHONE_BETA_SUPPORT_MATRIX.yaml` -> `ANDROID_WINDOWS_FEATURE_PARITY.yaml`; the first defines the experience, the second bounds honest phone-beta claims, and the third retains exhaustive cross-platform parity truth.
...
177. `ANDROID_APP_PRODUCT_SPEC.md`
178. `ANDROID_PHONE_BETA_SUPPORT_MATRIX.yaml`
179. `ANDROID_WINDOWS_FEATURE_PARITY.yaml`
