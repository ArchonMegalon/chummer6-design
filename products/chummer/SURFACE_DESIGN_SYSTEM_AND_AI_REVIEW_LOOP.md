...
### 8. Human-facing copy stays quiet

Public and product surfaces should not announce the machinery behind them.

Required:

* use Chummer-owned names for surfaces, actions, and states
* say the next action before any explanation
...
* "generated by AI" as decorative provenance
...
* Does the surface avoid visible AI/provider tells unless disclosure is required?
* Is explanatory text minimal enough that the workflow stands on its own?
