...
* `knowledge-fabric.md` - build-time grounded rules understanding and cited explain lanes
...
* `ghostwire.md` - replay, forensics, and after-action review
* `local-co-processor.md` - optional local acceleration without mandatory BYOC
