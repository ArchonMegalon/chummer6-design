...
KARMA FORGE is Chummer’s reviewed house-rule and custom-rules layer: a way for GMs, players, creators, organizers, and living communities to change the rules of their table without turning every campaign into an incompatible private fork.
...
That is the difference between “we have a house rule” and “we have a reviewed rule environment.”
...
> “An SR6 runner built under this exact campaign environment, with these source packs, this amend graph, these options, this fingerprint, and these records.”
...
That record is the table’s safety path.
...
Effect:
Renraku hosts in Tacoma gain stronger counter-intrusion status.
...
> “This imported into the accepted amend graph. Here is what worked, what was lossy, and what requires review.”
...
That means every package needs a visibility and approval status:
...
Not as authority. AI may help draft or discover demand. kept in Chummer rule packages, reviews, and change records determine what is real.
