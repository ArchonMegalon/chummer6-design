...
**Turn approved Chummer state into reusable books and modules.**
...
No. It must use approved approved inputs and preserve review state.
...
- renderer owning publication state
...
**RUNBOOK PRESS is where Chummer turns living campaign state into long-form material that can be read, reused, taught, and published.**
