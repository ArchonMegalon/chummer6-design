...
Builders get grounded what-if checks instead of vague assistant advice.
...
ALICE should compare, simulate, and explain using kept in Chummer engine state.
...
It may use assistant phrasing or drafting support, but mechanics come from kept in Chummer engine state.
