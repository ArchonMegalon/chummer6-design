...
The first safe route into Chummer stays calm, guided, and receipt-backed instead of feeling like setup theater.

![ONRAMP horizon art](../assets/horizons/onramp.png)

## Why this matters

New or rusty users still hit jargon, legality, and recovery friction before they reach a playable first session.

Picture the scene: A new player signs in, lands on a starter workspace, sees the next safe action, and can recover the lane without losing trust when a device or session goes wrong.
