...
Windows preview builds are the public path today. The download page is the authority for exactly which artifacts are live, and Linux or macOS are not public unless that page says they are.
