...
- **What platforms are publicly available today?** the platforms listed on Download are the current public path; check Download for exact status.
...
Yes. Start with Download and Status: both consume the same release-state projection, while each optional campaign tool keeps its own availability label.
