...
UI Kit is real enough to matter, and the next evidence is whether the rest of the product can use it instead of rebuilding the same visual pieces over and over.
