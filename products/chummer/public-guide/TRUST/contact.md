---
title: "Open the right support case"
...
You can submit help here without a GitHub account. Create a Chummer account when you want case history, linked installs, and release follow-up to stay visible in Account.

## GitHub is the advanced public bug lane, not the main support door

Use the public issue tracker only when you intentionally want a public technical discussion. Normal customers should be able to start with the first-party product surface.
