...
- `/partizipate` is the first-party board shell that brings feedback, roadmap, and shipped closeout together for guests without exposing a third-party product boundary.
